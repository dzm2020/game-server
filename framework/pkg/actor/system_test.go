...
func (a *doneAwareActor) OnInit(ctx Context) {
	go func() {
		<-ctx.Done()
...
func (a *doneAwareActor) OnDestroy(Context)    {}
func (a *doneAwareActor) OnMessage(Context)    {}
func (a *doneAwareActor) OnPanic(Context, any) {}
